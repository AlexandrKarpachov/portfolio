...
insert into users (login, name, surname, password, phone, role) values ('root', 'admin', 'sur', '123', '+380985055555', 'USER');

insert into bodies ("type") values ('Sedan');
insert into engines (power, "type", volume) values (150, 'DIESEL', 2.0);
insert into cars (brand, is_active, model, price, shift_gear, year, body_id, engine_id, user_id, description, created) values ('Audi', 'true', 'A 4', 10000, 'AUTO', 2017, 1, 1, 1, 'описание автомобиля', CURRENT_TIMESTAMP);
...
insert into cars (brand, is_active, model, price, shift_gear, year, body_id, engine_id, user_id, description, created) values ('Aston Martin', 'true', 'DB 5', 210000, 'MANUAL', 1965, 2, 2, 1, 'James Bond Car', CURRENT_TIMESTAMP);
...
insert into cars (brand, is_active, model, price, shift_gear, year, body_id, engine_id, user_id, description, created) values ('Mercedes', 'true', 'C class', 40000, 'AUTO', 2016, 3, 3, 1, 'new mercedes', CURRENT_TIMESTAMP);
